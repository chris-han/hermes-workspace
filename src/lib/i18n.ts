...
const EN: Record<string, string> = {
  ...
  'nav.effectiveContext': 'Effective Context',
  'nav.dataConnections': 'Data Connections',
  'nav.memory': 'Memory',
  'nav.knowledgeBase': 'Knowledge Base',
  'nav.evaluation': 'Evaluation',
  'nav.legalCorpus': 'Knowledge Base',
  'nav.generatedPolicies': 'Generated Policies',
  'nav.skills': 'Skills',
  'nav.profiles': 'Profiles',
  'nav.settings': 'Settings',
  // Memory
  'memory.tabs.memory': 'Memory',
  'memory.tabs.knowledge': 'Knowledge',
  'memory.tabs.governance': 'Governance',
  // Skills
...
const ES: typeof EN = {
  ...
  'nav.effectiveContext': 'Contexto efectivo',
  ...
  'memory.tabs.memory': 'Memoria',
  'memory.tabs.knowledge': 'Conocimiento',
  'memory.tabs.governance': 'Gobernanza',
...
const FR: typeof EN = {
  ...
  'nav.effectiveContext': 'Contexte effectif',
  ...
  'memory.tabs.memory': 'Mémoire',
  'memory.tabs.knowledge': 'Connaissance',
  'memory.tabs.governance': 'Gouvernance',
...
const ZH: typeof EN = {
  ...
  'nav.database': '数据库',
  'nav.effectiveContext': '有效背景信息',
  'nav.dataConnections': '数据连接',
  'nav.memory': '记忆',
  'nav.knowledgeBase': '知识库',
  'nav.evaluation': '评估',
  'nav.legalCorpus': '知识库',
  'nav.generatedPolicies': '生成策略',
  'nav.skills': '技能',
  'nav.profiles': '角色配置',
  'nav.settings': '设置',
  'memory.tabs.memory': '记忆',
  'memory.tabs.knowledge': '知识',
  'memory.tabs.governance': '治理',
