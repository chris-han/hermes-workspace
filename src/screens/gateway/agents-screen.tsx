    ...
    <div className="min-h-full bg-surface px-4 pb-24 pt-5 text-primary-900 dark:text-neutral-100 md:px-6 md:pb-4 md:pt-8">
      <div className="mx-auto w-full max-w-[1200px]">
        ...
        <div className="flex-1 overflow-auto">
          {agentsQuery.isLoading && !agentsQuery.data ? (
            ...
            <div className="rounded-2xl border border-border bg-white/60 p-5 shadow-sm backdrop-blur-md dark:bg-neutral-900/50">
      ...
      {selectedHistoryAgent ? (
        <div className="fixed inset-0 z-[90] md:hidden">
          ...
          <div className="absolute inset-x-4 top-[12vh] rounded-2xl border border-border bg-white/90 p-4 shadow-lg backdrop-blur-md dark:bg-neutral-900/90">
                  ...
                  .map((session, index) => {
                    ...
                    return (
                      <div
                        ...
                        className="rounded-xl border border-border bg-white/60 p-2.5 dark:bg-neutral-900/40"
                      >
