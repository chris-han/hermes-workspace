      ...
      <div className="mx-auto max-w-[1200px] space-y-6 px-4 py-6 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-4 border-b border-border pb-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <NativeSelect aria-label="Execution mode" value={mode} onChange={(event) => setMode(event.target.value as ExecutionMode)} className="rounded-md border border-border bg-card px-3 py-2 text-sm"><option value="real">{c.real}</option><option value="recorded">{c.recorded}</option><option value="in_memory">{c.inMemory}</option></NativeSelect>
