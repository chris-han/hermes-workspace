...
export function MemoryBrowserScreen() {
  ...
  return (
    <div
      className="h-full min-h-0 overflow-y-auto bg-surface text-ink"
      style={{ backgroundColor: 'var(--theme-bg)', color: 'var(--theme-text)' }}
    >
      <div className="mx-auto flex min-h-full w-full max-w-[1200px] flex-col px-4 py-6 pb-[calc(var(--tabbar-h,80px)+1.5rem)] sm:px-6 lg:px-8">
        <div
