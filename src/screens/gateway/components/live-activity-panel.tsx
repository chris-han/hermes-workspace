...
function AgentCard({
  ...
  return (
    <div
      className={cn(
        'rounded-2xl border bg-white/70 backdrop-blur dark:bg-neutral-900/50 border-border p-3 transition-all',
        isSelected
...
export function LiveActivityPanel({
  ...
  return (
    <div className="flex h-full flex-col border-l border-border bg-white dark:bg-neutral-950">
      {/* ── Panel header + tab switcher ──────────────────────────────────── */}
      <div className="flex shrink-0 items-center justify-between border-b border-border bg-white/80 px-3 py-2 backdrop-blur dark:bg-neutral-950/70">
        <div className="flex items-center gap-2">
