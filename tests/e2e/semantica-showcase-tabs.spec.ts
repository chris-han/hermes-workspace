/**
 * W7-07: Remote-Chrome Playwright (CDP :9222) — open each of four tabs and
...
test.describe('Semantica showcase — four-tab navigation (W7-07)', () => {
  test('each of the four visualization tabs is present with the expected label', async ({ page }) => {
