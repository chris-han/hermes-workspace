        ...
        <script
          ...
          (function(){
            ...
            d.innerHTML = '<img src="/logo.svg" alt="semantier logo" style="width:80px;height:80px;margin-bottom:20px;border-radius:16px;filter:drop-shadow(0 8px 32px color-mix(in srgb,'+accent+' 45%, transparent))" />'
              + '<div style="font-family:Plus Jakarta Sans,Noto Sans SC,-apple-system,system-ui,Segoe UI,Roboto,Arial,sans-serif;font-size:22px;line-height:1.2;font-weight:600;letter-spacing:-0.02em;color:'+txt+';margin-bottom:8px;text-transform:lowercase;">semantier</div>'
